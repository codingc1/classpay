...
function PopupCenterHCustom({  onClose, contents=defaultContents, option, isTopClose  }:
    ...
    return ( //
        <Portal elementId="modal">               
            ...
            >
              ...
              <div style={{ boxSizing: 'border-box', position: 'fixed',width: `${option.width}px`,maxWidth: '480px', height: `${option.height}px`, zIndex: 1001,
                top: `${calTop(option.height)}%`,left:`${calWidth(option.width)}%`,  margin: '0 auto', padding: '10px 20px', border:'1px solid black'}}
...
export default React.memo(PopupCenterHCustom)
