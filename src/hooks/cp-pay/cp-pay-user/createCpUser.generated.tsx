...
export type cp_modifyProfileMutationMutationVariables = Types.Exact<{
  modifyCpProfileInput: Types.ModifyCpProfileInput;
}>;


export type cp_modifyProfileMutationMutation = { __typename?: 'Mutation', cp_modifyProfile: { __typename?: 'CoreOutput', ok: boolean, error: string | null } };
...
export const cp_modifyProfileMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"cp_modifyProfileMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"modifyCpProfileInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ModifyCpProfileInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cp_modifyProfile"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"modifyCpProfileInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ok"}},{"kind":"Field","name":{"kind":"Name","value":"error"}}]}}]}}]} as unknown as DocumentNode<cp_modifyProfileMutationMutation, cp_modifyProfileMutationMutationVariables>;