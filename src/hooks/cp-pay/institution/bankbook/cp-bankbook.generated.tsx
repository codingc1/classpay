...
export type cp_insti_sendMoneyMutationMutationVariables = Types.Exact<{
  cp_instiAcitveSendMoneyInput: Types.CP_InstiAcitveSendMoneyInput;
}>;


export type cp_insti_sendMoneyMutationMutation = { __typename?: 'Mutation', cp_insti_sendMoney: { __typename?: 'CoreOutput', ok: boolean, error: string | null } };
...
export const cp_insti_sendMoneyMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"cp_insti_sendMoneyMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"cp_instiAcitveSendMoneyInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CP_InstiAcitveSendMoneyInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cp_insti_sendMoney"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"cp_instiAcitveSendMoneyInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ok"}},{"kind":"Field","name":{"kind":"Name","value":"error"}}]}}]}}]} as unknown as DocumentNode<cp_insti_sendMoneyMutationMutation, cp_insti_sendMoneyMutationMutationVariables>;
