...
export type cp_sellingStartMutationMutation = { __typename?: 'Mutation', cp_sellingStart: { __typename?: 'CP_TradeTmpCodeOutput', ok: boolean, error: string | null, result: { __typename?: 'CP_TradeTmpCode', id: number, product_id: number, cppay_id: number, seller_id: number, seller_name: string, name: string, qty: number, price: number, sumPrice: number, code: string } | null } };
...
export type pendingSellingSubscriptionSubscription = { __typename?: 'Subscription', pendingSelling: { __typename?: 'CoreOutput', ok: boolean, error: string | null } };
