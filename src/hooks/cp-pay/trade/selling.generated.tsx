...
export type cp_sellingStopMutationMutationVariables = Types.Exact<{
  idOnlyInput: Types.IdOnlyInput;
}>;


export type cp_sellingStopMutationMutation = { __typename?: 'Mutation', cp_sellingStop: { __typename?: 'CoreOutput', ok: boolean, error: string | null } };
...
export const cp_sellingStopMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"cp_sellingStopMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"idOnlyInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"IdOnlyInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cp_sellingStop"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"idOnlyInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ok"}},{"kind":"Field","name":{"kind":"Name","value":"error"}}]}}]}}]} as unknown as DocumentNode<cp_sellingStopMutationMutation, cp_sellingStopMutationMutationVariables>;