...
export type cp_teacherGetBankBookAllMutationMutationVariables = Types.Exact<{
  yearMonthDayInput: Types.YearMonthDayInput;
}>;
...
export type cp_teacherGetOneStudentBillMutationMutationVariables = Types.Exact<{
  teacherGetMonth: Types.TeacherGetMonth;
}>;


export type cp_teacherGetOneStudentBillMutationMutation = { __typename?: 'Mutation', cp_teacherGetOneStudentBill: Array<{ __typename?: 'CP_Bill', id: number, cppay_id: number, seller_id: number, seller_name: string, consumer_id: number, consumer_name: string, kind: Types.BILL_KIND_TYPE, name: string, desciption: string, qty: number, price: number, sumPrice: number, createdAt: any }> };
...
export const cp_teacherGetBankBookAllMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"cp_teacherGetBankBookAllMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"yearMonthDayInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"YearMonthDayInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cp_teacherGetBankBookAll"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"yearMonthDayInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"CP_BankBookParts"}}]}}]}},...CP_BankBookPartsFragmentDoc.definitions]} as unknown as DocumentNode<cp_teacherGetBankBookAllMutationMutation, cp_teacherGetBankBookAllMutationMutationVariables>;
...
export const cp_teacherGetMarketTradeAllMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"cp_teacherGetMarketTradeAllMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"yearMonthDayInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"YearMonthDayInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cp_teacherGetMarketTradeAll"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"yearMonthDayInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"CP_BillParts"}}]}}]}},...CP_BillPartsFragmentDoc.definitions]} as unknown as DocumentNode<cp_teacherGetMarketTradeAllMutationMutation, cp_teacherGetMarketTradeAllMutationMutationVariables>;
export const cp_teacherGetOneStudentBillMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"cp_teacherGetOneStudentBillMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"teacherGetMonth"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"TeacherGetMonth"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cp_teacherGetOneStudentBill"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"teacherGetMonth"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"CP_BillParts"}}]}}]}},...CP_BillPartsFragmentDoc.definitions]} as unknown as DocumentNode<cp_teacherGetOneStudentBillMutationMutation, cp_teacherGetOneStudentBillMutationMutationVariables>;