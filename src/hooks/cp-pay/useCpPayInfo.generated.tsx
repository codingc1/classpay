...
export type cp_PayInfoQueryQuery = { __typename?: 'Query', cp_PayInfo: { __typename?: 'CP_PayOutput', ok: boolean, error: string | null, result: { __typename?: 'CP_Pay', id: number, user_id: number, className: string, schoolName: string, classTh: number, classNum: number, code: string, imgurl: string, moneyUnit: string, numberOfDigits: number } | null } };
