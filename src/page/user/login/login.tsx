...
const [handleError] = useError()
  ...
  return ( //
    ...
    <div className="w-full h-screen flex items-center flex-col justify-center">
        <Helmet><title>물고기 교실경제 로그인</title>
          <meta name="title" content="물고기 교실경제" />
          <meta name="description" content="물고기 교실경제입니다, 구글크롬에서 작동합니다." />
          <meta property="og:title" content="물고기 교실경제 로그인" />
          <meta property="og:description" content="물고기 교실경제 로그인입니다" />
    ...
    <div className="-mt-3 w-full max-w-sm flex flex-col justify-center items-center">
      <div className=" mb-3 text-4xl font-mono text-center">물고기 교실경제</div>  
