    ...
    return(
        <div className="py-3 w-full flex">
            ...
            {/* <div className="" style={{width:'35%'}}>
                <div>{bankbook.desciption||'_'}</div>
                <div>{addCommaMan(bankbook.price)}{moneyUnit}</div>
            </div> */}
            <div className="" style={{width:'35%'}}>
            ...
            {/* <div className="" style={{width:'44%'}}>
                <div className="w-full flex justify-end "><div className="text-right">{isIncome()?bankbook.sender_name||' ':bankbook.receiver_name}</div></div>
            ...
            <div className="" style={{width:'44%'}}>
                ...
                {/* <div className="w-full flex justify-end "><div className="text-right">{bankbook.desciption}</div></div> */}
                <div className="w-full flex justify-end "><div className="text-right text-gray-400 text-sm">{madeDate}</div></div>
            </div>
        </div>
