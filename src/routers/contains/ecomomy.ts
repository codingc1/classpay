...
export const CP_INSTITUTION_CENTERBANK_ROUTE_NAME = '/classpay/institution/centerbank'//중앙은행
export const CP_INSTITUTION_BANK_ROUTE_NAME = '/classpay/institution/bank'//은행
